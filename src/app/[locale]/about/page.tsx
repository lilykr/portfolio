...
export default function About() {
  ...
  return (
    <div
      className="relative z-10 h-[calc(100dvh-23px)] flex flex-col tablet:flex-row tablet:justify-center tablet:items-center tablet:pt-0 pt-[calc((100dvh)/3-100px)] tablet:px-16"
      id="about-section">
      ...
      <div className="flex items-center w-[50%] m-auto mt-12 tablet:mt-[0px] tablet:w-[350px] h-full">
