...
export const Header = () => {
  ...
  return (
    <div className="fixed w-[50px] flex tablet:w-[calc(100%-22px)] p-[15px] tablet:p-[26px] rotate-90 tablet:rotate-0 text-body13 laptop:text-body18 tablet:bg-black tablet:bg-opacity-80 z-50">
      ...
      <div className="absolute top-0 -right-[324px] tablet:top-[26px] flex tablet:justify-end tablet:w-[600px] w-max rotate-180 tablet:rotate-0 pb-[16px] tablet:pb-0 pt-[17px] tablet:pt-0 pr-12 tablet:pr-0 bg-black bg-opacity-80 tablet:bg-opacity-0 text-body11 laptop:text-body18 -z-[1] tablet:z-10">
